...
b=this.s.multiIds,c=this.s.multiValues,e=this.s.multiValue,d=this.s.opts.multiEditable,h,j=!1;if(b)for(var f=0;f<b.length;f++){h=c[b[f]];if(0<f&&!H(h,a)){j=!0;break}a=h}j&&e||!d&&this.isMultiValue()?(this.dom.inputControl.css({display:"none"}),this.dom.multi.css({display:"block"})):(this.dom.inputControl.css({display:"block"}),this.dom.multi.css({display:"none"}),e&&!j&&this.set(a,!1));this.dom.multiReturn.css({display:b&&1<b.length&&j&&!e?"block":"none"});a=this.s.host.i18n.multi;this.dom.multiInfo.html(d?
a.info:a.noMulti);this.dom.multi.toggleClass(this.s.classes.multiNoEdit,!d);this.s.host._multiInfo();return!0},_typeFn:function(a){var b=Array.prototype.slice.call(arguments);b.shift();b.unshift(this.s.opts);var c=this.s.type[a];if(c)return c.apply(this.s.host,b)}};f.Field.models={};f.Field.defaults={className:"",data:"",def:"",fieldInfo:"",id:"",label:"",labelInfo:"",name:null,type:"text",message:"",multiEditable:!0};f.Field.models.settings={type:null,name:null,classes:null,opts:null,host:null};
f.Field.models.dom={container:null,label:null,labelInfo:null,fieldInfo:null,fieldError:null,fieldMessage:null};f.models={};f.models.displayController={init:function(){},open:function(){},close:function(){}};f.models.fieldType={create:function(){},get:function(){},set:function(){},enable:function(){},disable:function(){}};f.models.settings={ajaxUrl:null,ajax:null,dataSource:null,domTable:null,opts:null,displayController:null,fields:{},order:[],id:-1,displayed:!1,processing:!1,modifier:null,action:null,
idSrc:null,unique:0};f.models.button={label:null,fn:null,className:null};f.models.formOptions={onReturn:"submit",onBlur:"close",onBackground:"blur",onComplete:"close",onEsc:"close",onFieldError:"focus",submit:"all",focus:0,buttons:!0,title:!0,message:!0,drawType:!1};f.display={};var r=jQuery,m;f.display.lightbox=r.extend(!0,{},f.models.displayController,{init:function(){m._init();return m},open:function(a,b,c){if(m._shown)c&&c();else{m._dte=a;a=m._dom.content;a.children().detach();a.append(b).append(m._dom.close);
m._shown=true;m._show(c)}},close:function(a,b){if(m._shown){m._dte=a;m._hide(b);m._shown=false}else b&&b()},node:function(){return m._dom.wrapper[0]},_init:function(){if(!m._ready){var a=m._dom;a.content=r("div.DTED_Lightbox_Content",m._dom.wrapper);a.wrapper.css("opacity",0);a.background.css("opacity",0)}},_show:function(a){var b=m._dom;p.orientation!==i&&r("body").addClass("DTED_Lightbox_Mobile");b.content.css("height","auto");b.wrapper.css({top:-m.conf.offsetAni});r("body").append(m._dom.background).append(m._dom.wrapper);
m._heightCalc();b.wrapper.stop().animate({opacity:1,top:0},a);b.background.stop().animate({opacity:1});setTimeout(function(){r("div.DTE_Footer").css("text-indent",-1)},10);b.close.bind("click.DTED_Lightbox",function(){m._dte.close()});b.background.bind("click.DTED_Lightbox",function(){m._dte.background()});r("div.DTED_Lightbox_Content_Wrapper",b.wrapper).bind("click.DTED_Lightbox",function(a){r(a.target).hasClass("DTED_Lightbox_Content_Wrapper")&&m._dte.background()});r(p).bind("resize.DTED_Lightbox",
function(){m._heightCalc()});m._scrollTop=r("body").scrollTop();if(p.orientation!==i){a=r("body").children().not(b.background).not(b.wrapper);r("body").append('<div class="DTED_Lightbox_Shown"/>');r("div.DTED_Lightbox_Shown").append(a)}},_heightCalc:function(){var a=m._dom,b=r(p).height()-m.conf.windowPadding*2-r("div.DTE_Header",a.wrapper).outerHeight()-r("div.DTE_Footer",a.wrapper).outerHeight();r("div.DTE_Body_Content",a.wrapper).css("maxHeight",b)},_hide:function(a){var b=m._dom;a||(a=function(){});
if(p.orientation!==i){var c=r("div.DTED_Lightbox_Shown");c.children().appendTo("body");c.remove()}r("body").removeClass("DTED_Lightbox_Mobile").scrollTop(m._scrollTop);b.wrapper.stop().animate({opacity:0,top:m.conf.offsetAni},function(){r(this).detach();a()});b.background.stop().animate({opacity:0},function(){r(this).detach()});b.close.unbind("click.DTED_Lightbox");b.background.unbind("click.DTED_Lightbox");r("div.DTED_Lightbox_Content_Wrapper",b.wrapper).unbind("click.DTED_Lightbox");r(p).unbind("resize.DTED_Lightbox")},
_dte:null,_ready:!1,_shown:!1,_dom:{wrapper:r('<div class="DTED DTED_Lightbox_Wrapper"><div class="DTED_Lightbox_Container"><div class="DTED_Lightbox_Content_Wrapper"><div class="DTED_Lightbox_Content"></div></div></div></div>'),background:r('<div class="DTED_Lightbox_Background"><div/></div>'),close:r('<div class="DTED_Lightbox_Close"></div>'),content:null}});m=f.display.lightbox;m.conf={offsetAni:25,windowPadding:25};var o=jQuery,g;f.display.envelope=o.extend(!0,{},f.models.displayController,{init:function(a){g._dte=
a;g._init();return g},open:function(a,b,c){g._dte=a;o(g._dom.content).children().detach();g._dom.content.appendChild(b);g._dom.content.appendChild(g._dom.close);g._show(c)},close:function(a,b){g._dte=a;g._hide(b)},node:function(){return g._dom.wrapper[0]},_init:function(){if(!g._ready){g._dom.content=o("div.DTED_Envelope_Container",g._dom.wrapper)[0];s.body.appendChild(g._dom.background);s.body.appendChild(g._dom.wrapper);g._dom.background.style.visbility="hidden";g._dom.background.style.display=
"block";g._cssBackgroundOpacity=o(g._dom.background).css("opacity");g._dom.background.style.display="none";g._dom.background.style.visbility="visible"}},_show:function(a){a||(a=function(){});g._dom.content.style.height="auto";var b=g._dom.wrapper.style;b.opacity=0;b.display="block";var c=g._findAttachRow(),e=g._heightCalc(),d=c.offsetWidth;b.display="none";b.opacity=1;g._dom.wrapper.style.width=d+"px";g._dom.wrapper.style.marginLeft=-(d/2)+"px";g._dom.wrapper.style.top=o(c).offset().top+c.offsetHeight+
"px";g._dom.content.style.top=-1*e-20+"px";g._dom.background.style.opacity=0;g._dom.background.style.display="block";o(g._dom.background).animate({opacity:g._cssBackgroundOpacity},"normal");o(g._dom.wrapper).fadeIn();g.conf.windowScroll?o("html,body").animate({scrollTop:o(c).offset().top+c.offsetHeight-g.conf.windowPadding},function(){o(g._dom.content).animate({top:0},600,a)}):o(g._dom.content).animate({top:0},600,a);o(g._dom.close).bind("click.DTED_Envelope",function(){g._dte.close()});o(g._dom.background).bind("click.DTED_Envelope",
function(){g._dte.background()});o("div.DTED_Lightbox_Content_Wrapper",g._dom.wrapper).bind("click.DTED_Envelope",function(a){o(a.target).hasClass("DTED_Envelope_Content_Wrapper")&&g._dte.background()});o(p).bind("resize.DTED_Envelope",function(){g._heightCalc()})},_heightCalc:function(){g.conf.heightCalc?g.conf.heightCalc(g._dom.wrapper):o(g._dom.content).children().height();var a=o(p).height()-g.conf.windowPadding*2-o("div.DTE_Header",g._dom.wrapper).outerHeight()-o("div.DTE_Footer",g._dom.wrapper).outerHeight();
o("div.DTE_Body_Content",g._dom.wrapper).css("maxHeight",a);return o(g._dte.dom.wrapper).outerHeight()},_hide:function(a){a||(a=function(){});o(g._dom.content).animate({top:-(g._dom.content.offsetHeight+50)},600,function(){o([g._dom.wrapper,g._dom.background]).fadeOut("normal",a)});o(g._dom.close).unbind("click.DTED_Lightbox");o(g._dom.background).unbind("click.DTED_Lightbox");o("div.DTED_Lightbox_Content_Wrapper",g._dom.wrapper).unbind("click.DTED_Lightbox");o(p).unbind("resize.DTED_Lightbox")},
_findAttachRow:function(){var a=o(g._dte.s.table).DataTable();return g.conf.attach==="head"?a.table().header():g._dte.s.action==="create"?a.table().header():a.row(g._dte.s.modifier).node()},_dte:null,_ready:!1,_cssBackgroundOpacity:1,_dom:{wrapper:o('<div class="DTED DTED_Envelope_Wrapper"><div class="DTED_Envelope_Shadow"></div><div class="DTED_Envelope_Container"></div></div>')[0],background:o('<div class="DTED_Envelope_Background"><div/></div>')[0],close:o('<div class="DTED_Envelope_Close">&times;</div>')[0],
content:null}});g=f.display.envelope;g.conf={windowPadding:50,heightCalc:null,attach:"row",windowScroll:!0};f.prototype.add=function(a,b){if(d.isArray(a))for(var c=0,e=a.length;c<e;c++)this.add(a[c]);else{c=a.name;if(c===i)throw"Error adding field. The field requires a `name` option";if(this.s.fields[c])throw"Error adding field '"+c+"'. A field already exists with this name";this._dataSource("initField",a);this.s.fields[c]=new f.Field(a,this.classes.field,this);b===i?this.s.order.push(c):null===b?
this.s.order.unshift(c):(e=d.inArray(b,this.s.order),this.s.order.splice(e+1,0,c))}this._displayReorder(this.order());return this};f.prototype.background=function(){var a=this.s.editOpts.onBackground;"function"===typeof a?a(this):"blur"===a?this.blur():"close"===a?this.close():"submit"===a&&this.submit();return this};f.prototype.blur=function(){this._blur();return this};f.prototype.bubble=function(a,b,c,e){var k=this;if(this._tidy(function(){k.bubble(a,b,e)}))return this;d.isPlainObject(b)?(e=b,b=
i,c=!0):"boolean"===typeof b&&(c=b,e=b=i);d.isPlainObject(c)&&(e=c,c=!0);c===i&&(c=!0);var e=d.extend({},this.s.formOptions.bubble,e),h=this._dataSource("individual",a,b);this._edit(a,h,"bubble");var j=this._formOptions(e);if(!this._preopen("bubble"))return this;d(p).on("resize."+j,function(){k.bubblePosition()});var f=[];this.s.bubbleNodes=f.concat.apply(f,B(h,"attach"));f=this.classes.bubble;h=d('<div class="'+f.bg+'"><div/></div>');f=d('<div class="'+f.wrapper+'"><div class="'+f.liner+'"><div class="'+
f.table+'"><div class="'+f.close+'" /><div class="DTE_Processing_Indicator"><span></div></div></div><div class="'+f.pointer+'" /></div>');c&&(f.appendTo("body"),h.appendTo("body"));var c=f.children().eq(0),l=c.children(),x=l.children();c.append(this.dom.formError);l.prepend(this.dom.form);e.message&&c.prepend(this.dom.formInfo);e.title&&c.prepend(this.dom.header);e.buttons&&l.append(this.dom.buttons);var v=d().add(f).add(h);this._closeReg(function(){v.animate({opacity:0},function(){v.detach();d(p).off("resize."+
j);k._clearDynamicInfo()})});h.click(function(){k.blur()});x.click(function(){k._close()});this.bubblePosition();v.animate({opacity:1});this._focus(this.s.includeFields,e.focus);this._postopen("bubble");return this};f.prototype.bubblePosition=function(){var a=d("div.DTE_Bubble"),b=d("div.DTE_Bubble_Liner"),c=this.s.bubbleNodes,e=0,k=0,h=0,f=0;d.each(c,function(a,b){var c=d(b).offset(),b=d(b).get(0);e+=c.top;k+=c.left;h+=c.left+b.offsetWidth;f+=c.top+b.offsetHeight});var e=e/c.length,k=k/c.length,
h=h/c.length,f=f/c.length,c=e,q=(k+h)/2,l=b.outerWidth(),x=q-l/2,l=x+l,i=d(p).width();a.css({top:c,left:q});b.length&&0>b.offset().top?a.css("top",f).addClass("below"):a.removeClass("below");l+15>i?b.css("left",15>x?-(x-15):-(l-i+15)):b.css("left",15>x?-(x-15):0);return this};f.prototype.buttons=function(a){var b=this;"_basic"===a?a=[{label:this.i18n[this.s.action].submit,fn:function(){this.submit()}}]:d.isArray(a)||(a=[a]);d(this.dom.buttons).empty();d.each(a,function(a,e){"string"===typeof e&&(e=
{label:e,fn:function(){this.submit()}});d("<button/>",{"class":b.classes.form.button+(e.className?" "+e.className:"")}).html("function"===typeof e.label?e.label(b):e.label||"").attr("tabindex",e.tabIndex!==i?e.tabIndex:0).on("keyup",function(a){13===a.keyCode&&e.fn&&e.fn.call(b)}).on("keypress",function(a){13===a.keyCode&&a.preventDefault()}).on("click",function(a){a.preventDefault();e.fn&&e.fn.call(b)}).appendTo(b.dom.buttons)});return this};f.prototype.clear=function(a){var b=this,c=this.s.fields;
"string"===typeof a?(c[a].destroy(),delete c[a],a=d.inArray(a,this.s.order),this.s.order.splice(a,1)):d.each(this._fieldNames(a),function(a,c){b.clear(c)});return this};f.prototype.close=function(){this._close(!1);return this};f.prototype.create=function(a,b,c,e){var k=this,h=this.s.fields,f=1;if(this._tidy(function(){k.create(a,b,c,e)}))return this;"number"===typeof a&&(f=a,a=b,b=c);this.s.editFields={};for(var q=0;q<f;q++)this.s.editFields[q]={fields:this.s.fields};f=this._crudArgs(a,b,c,e);this.s.mode=
"main";this.s.action="create";this.s.modifier=null;this.dom.form.style.display="block";this._actionClass();this._displayReorder(this.fields());d.each(h,function(a,b){b.multiReset();b.set(b.def())});this._event("initCreate");this._assembleMain();this._formOptions(f.opts);f.maybeOpen();return this};f.prototype.dependent=function(a,b,c){if(d.isArray(a)){for(var e=0,k=a.length;e<k;e++)this.dependent(a[e],b,c);return this}var h=this,f=this.field(a),q={type:"POST",dataType:"json"},c=d.extend({event:"change",
data:null,preUpdate:null,postUpdate:null},c),l=function(a){c.preUpdate&&c.preUpdate(a);d.each({labels:"label",options:"update",values:"val",messages:"message",errors:"error"},function(b,c){a[b]&&d.each(a[b],function(a,b){h.field(a)[c](b)})});d.each(["hide","show","enable","disable"],function(b,c){if(a[c])h[c](a[c])});c.postUpdate&&c.postUpdate(a)};d(f.node()).on(c.event,function(a){if(0!==d(f.node()).find(a.target).length){a={};a.rows=h.s.editFields?B(h.s.editFields,"data"):null;a.row=a.rows?a.rows[0]:
null;a.values=h.val();if(c.data){var e=c.data(a);e&&(c.data=e)}"function"===typeof b?(a=b(f.val(),a,l))&&l(a):(d.isPlainObject(b)?d.extend(q,b):q.url=b,d.ajax(d.extend(q,{url:b,data:a,success:l})))}});return this};f.prototype.destroy=function(){this.s.displayed&&this.close();this.clear();var a=this.s.displayController;a.destroy&&a.destroy(this);d(s).off(".dte"+this.s.unique);this.s=this.dom=null};f.prototype.disable=function(a){var b=this.s.fields;d.each(this._fieldNames(a),function(a,e){b[e].disable()});
return this};f.prototype.display=function(a){return a===i?this.s.displayed:this[a?"open":"close"]()};f.prototype.displayed=function(){return d.map(this.s.fields,function(a,b){return a.displayed()?b:null})};f.prototype.displayNode=function(){return this.s.displayController.node(this)};f.prototype.edit=function(a,b,c,e,d){var h=this;if(this._tidy(function(){h.edit(a,b,c,e,d)}))return this;var f=this._crudArgs(b,c,e,d);this._edit(a,this._dataSource("fields",a),"main");this._assembleMain();this._formOptions(f.opts);
f.maybeOpen();return this};f.prototype.enable=function(a){var b=this.s.fields;d.each(this._fieldNames(a),function(a,e){b[e].enable()});return this};f.prototype.error=function(a,b){b===i?this._message(this.dom.formError,a):this.s.fields[a].error(b);return this};f.prototype.field=function(a){return this.s.fields[a]};f.prototype.fields=function(){return d.map(this.s.fields,function(a,b){return b})};f.prototype.file=n;f.prototype.files=D;f.prototype.get=function(a){var b=this.s.fields;a||(a=this.fields());
...
c),k=this._dataSource("individual",a,b),h,f,q=0,l,x=!1,g=this.classes.inline;d.each(k,function(a,b){if(q>0)throw"Cannot edit more than one row inline at a time";h=d(b.attach[0]);l=0;d.each(b.displayFields,function(a,b){if(l>0)throw"Cannot edit more than one field inline at a time";f=b;l++});q++});if(d("div.DTE_Field",h).length||this._tidy(function(){e.inline(a,b,c)}))return this;this._edit(a,k,"inline");var E=this._formOptions(c);if(!this._preopen("inline"))return this;var G=h.contents().detach();
h.append(d('<div class="'+g.wrapper+'"><div class="'+g.liner+'"><div class="DTE_Processing_Indicator"><span/></div></div><div class="'+g.buttons+'"/></div>'));h.find("div."+g.liner.replace(/ /g,".")).append(f.node()).append(this.dom.formError);c.buttons&&h.find("div."+g.buttons.replace(/ /g,".")).append(this.dom.buttons);this._closeReg(function(a){x=true;d(s).off("click"+E);if(!a){h.contents().detach();h.append(G)}e._clearDynamicInfo()});setTimeout(function(){if(!x)d(s).on("click"+E,function(a){var b=
d.fn.addBack?"addBack":"andSelf";!f._typeFn("owns",a.target)&&d.inArray(h[0],d(a.target).parents()[b]())===-1&&e.blur()})},0);this._focus([f],c.focus);this._postopen("inline");return this};f.prototype.message=function(a,b){b===i?this._message(this.dom.formInfo,a):this.s.fields[a].message(b);return this};f.prototype.mode=function(){return this.s.action};f.prototype.modifier=function(){return this.s.modifier};f.prototype.multiGet=function(a){var b=this.s.fields;a===i&&(a=this.fields());if(d.isArray(a)){var c=
...
datetime:{previous:"Previous",next:"Next",months:"January February March April May June July August September October November December".split(" "),weekdays:"Sun Mon Tue Wed Thu Fri Sat".split(" "),amPm:["am","pm"],unknown:"-"}},formOptions:{bubble:d.extend({},f.models.formOptions,{title:!1,message:!1,buttons:"_basic",submit:"changed"}),inline:d.extend({},f.models.formOptions,{buttons:!1,submit:"changed"}),main:d.extend({},f.models.formOptions)},legacyAjax:!1};var P=function(a,b,c){d.each(b,function(b,
d){var f=d.valFromData(c);if(f!==i){var j=I(a,d.dataSrc());j.filter("[data-editor-value]").length?j.attr("data-editor-value",f):j.each(function(){for(;this.childNodes.length;)this.removeChild(this.firstChild)}).html(f)}})},I=function(a,b){var c="keyless"===a?s:d('[data-editor-id="'+a+'"]');return d('[data-editor-field="'+b+'"]',c)},J=f.dataSources={},K=function(a,b){return a.settings()[0].oFeatures.bServerSide&&"none"!==b.s.editOpts.drawType},Q=function(a){a=d(a);setTimeout(function(){a.addClass("highlight");
setTimeout(function(){a.addClass("noHighlight").removeClass("highlight");setTimeout(function(){a.removeClass("noHighlight")},550)},500)},20)},L=function(a,b,c,e,d){b.rows(c).indexes().each(function(c){var c=b.row(c),j=c.data(),g=d(j);g===i&&f.error("Unable to find row identifier",14);a[g]={idSrc:g,data:j,node:c.node(),fields:e,type:"row"}})},M=function(a,b,c,e,k,h){b.cells(c).indexes().each(function(j){var g=b.cell(j),l=b.row(j.row).data(),l=k(l),m;if(!(m=h)){m=j.column;m=b.settings()[0].aoColumns[m];
var n=m.editField!==i?m.editField:m.mData,o={};d.each(e,function(a,b){if(d.isArray(n))for(var c=0;c<n.length;c++){var e=b,f=n[c];e.name()===f&&(o[e.name()]=e)}else b.name()===n&&(o[b.name()]=b)});d.isEmptyObject(o)&&f.error("Unable to automatically determine field from source. Please specify the field name.",11);m=o}var p="object"===typeof c&&c.nodeName||c instanceof d;L(a,b,j.row,e,k);a[l].attach=p?[d(c).get(0)]:[g.node()];a[l].displayFields=m})},R=function(a){return"string"===typeof a?"#"+a.replace(/(:|\.|\[|\]|,)/g,
"\\$1"):"#"+a};J.dataTable={individual:function(a,b){var c=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),e=d(this.s.table).DataTable(),f=this.s.fields,h={},j;b&&(d.isArray(b)||(b=[b]),j={},d.each(b,function(a,b){j[b]=f[b]}));M(h,e,a,f,c,j);return h},fields:function(a){var b=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),c=d(this.s.table).DataTable(),e=this.s.fields,f={};d.isPlainObject(a)&&(a.rows!==i||a.columns!==i||a.cells!==i)?(a.rows!==i&&L(f,c,a.rows,e,b),a.columns!==i&&c.cells(null,a.columns).indexes().each(function(a){M(f,
c,a,e,b)}),a.cells!==i&&M(f,c,a.cells,e,b)):L(f,c,a,e,b);return f},create:function(a,b){var c=d(this.s.table).DataTable();K(c,this)||(c=c.row.add(b),Q(c.node()))},edit:function(a,b,c,e){a=d(this.s.table).DataTable();if(!K(a,this)||"none"===this.s.editOpts.drawType){var f=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),h=f(c),j;try{j=a.row(R(h))}catch(g){j=a}j.any()||(j=a.row(function(a,b){return h==f(b)}));j.any()?(j.data(c),c=d.inArray(h,e.rowIds),e.rowIds.splice(c,1)):j=a.row.add(c);Q(j.node())}},remove:function(a,
b,c){var b=d(this.s.table).DataTable(),e=c.cancelled;if(!K(b,this))if(0===e.length)b.rows(a).remove();else{var f=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),h=[];b.rows(a).every(function(){var a=f(this.data());-1===d.inArray(a,e)&&h.push(this.index())});b.rows(h).remove()}},prep:function(a,b,c,e,f){if("edit"===a){var h=e.cancelled||[];f.rowIds=d.map(c.data,function(a,b){return!d.isEmptyObject(c.data[b])&&-1===d.inArray(b,h)?b:i})}else"remove"===a&&(f.cancelled=e.cancelled||[])},commit:function(a,
b,c,e){b=d(this.s.table).DataTable();if("edit"===a&&e.rowIds.length)for(var f=e.rowIds,h=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),g=0,e=f.length;g<e;g++)a=b.row(R(f[g])),a.any()||(a=b.row(function(a,b){return f[g]==h(b)})),a.any()&&a.remove();a=this.s.editOpts.drawType;"none"!==a&&b.draw(a)}};J.html={initField:function(a){var b=d('[data-editor-label="'+(a.data||a.name)+'"]');!a.label&&b.length&&(a.label=b.html())},individual:function(a,b){var c;if(a instanceof d||a.nodeName){c=a;b||(b=[d(a).attr("data-editor-field")]);
var e=d.fn.addBack?"addBack":"andSelf",a=d(a).parents("[data-editor-id]")[e]().data("editor-id")}a||(a="keyless");b&&!d.isArray(b)&&(b=[b]);if(!b||0===b.length)throw"Cannot automatically determine field name from data source";var e=J.html.fields.call(this,a),f=this.s.fields,h={};d.each(b,function(a,b){h[b]=f[b]});d.each(e,function(e,g){g.type="cell";var i;if(c)i=d(c);else{i=a;for(var m=b,n=d(),o=0,p=m.length;o<p;o++)n=n.add(I(i,m[o]));i=n.toArray()}g.attach=i;g.fields=f;g.displayFields=h});return e},
fields:function(a){var b={},c={},e=this.s.fields;a||(a="keyless");d.each(e,function(b,e){var d;d=e.dataSrc();d=I(a,d);d=d.filter("[data-editor-value]").length?d.attr("data-editor-value"):d.html();e.valToData(c,null===d?i:d)});b[a]={idSrc:a,data:c,node:s,fields:e,type:"row"};return b},create:function(a,b){if(b){var c=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(b);d('[data-editor-id="'+c+'"]').length&&P(c,a,b)}},edit:function(a,b,c){a=t.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(c)||"keyless";P(a,b,
...
0},val:function(a,b){if(a===i)return this.s.d;if(a instanceof Date)this.s.d=this._dateToUtc(a);else if(a===null||a==="")this.s.d=null;else if(typeof a==="string")if(p.moment){var c=p.moment.utc(a,this.c.format,this.c.momentLocale,this.c.momentStrict);this.s.d=c.isValid()?c.toDate():null}else{c=a.match(/(\d{4})\-(\d{2})\-(\d{2})/);this.s.d=c?new Date(Date.UTC(c[1],c[2]-1,c[3])):null}if(b||b===i)this.s.d?this._writeOutput():this.dom.input.val(a);if(!this.s.d)this.s.d=this._dateToUtc(new Date);this.s.display=
...
this._dateToUtc(new Date),e=this._daysInMonth(a,b),f=(new Date(Date.UTC(a,b,1))).getUTCDay(),h=[],g=[];if(this.c.firstDay>0){f=f-this.c.firstDay;f<0&&(f=f+7)}for(var i=e+f,l=i;l>7;)l=l-7;var i=i+(7-l),l=this.c.minDate,m=this.c.maxDate;if(l){l.setUTCHours(0);l.setUTCMinutes(0);l.setSeconds(0)}if(m){m.setUTCHours(23);m.setUTCMinutes(59);m.setSeconds(59)}for(var n=0,o=0;n<i;n++){var p=new Date(Date.UTC(a,b,1+(n-f))),r=this.s.d?this._compareDates(p,this.s.d):false,s=this._compareDates(p,c),t=n<f||n>=
e+f,u=l&&p<l||m&&p>m,w=this.c.disableDays;d.isArray(w)&&d.inArray(p.getUTCDay(),w)!==-1?u=true:typeof w==="function"&&w(p)===true&&(u=true);g.push(this._htmlDay({day:1+(n-f),month:b,year:a,selected:r,today:s,disabled:u,empty:t}));if(++o===7){this.c.showWeekNumber&&g.unshift(this._htmlWeekOfYear(n-f,b,a));h.push("<tr>"+g.join("")+"</tr>");g=[];o=0}}c=this.c.classPrefix+"-table";this.c.showWeekNumber&&(c=c+" weekNumber");return'<table class="'+c+'"><thead>'+this._htmlMonthHead()+"</thead><tbody>"+h.join("")+
"</tbody></table>"},_htmlMonthHead:function(){var a=[],b=this.c.firstDay,c=this.c.i18n,e=function(a){for(a=a+b;a>=7;)a=a-7;return c.weekdays[a]};this.c.showWeekNumber&&a.push("<th></th>");for(var d=0;d<7;d++)a.push("<th>"+e(d)+"</th>");return a.join("")},_htmlWeekOfYear:function(a,b,c){a=new Date(c,b,a,0,0,0,0);a.setDate(a.getDate()+4-(a.getDay()||7));c=Math.ceil(((a-new Date(c,0,1))/864E5+1)/7);return'<td class="'+this.c.classPrefix+'-week">'+c+"</td>"},_options:function(a,b,c){c||(c=b);a=this.dom.container.find("select."+
this.c.classPrefix+"-"+a);a.empty();for(var e=0,d=b.length;e<d;e++)a.append('<option value="'+b[e]+'">'+c[e]+"</option>")},_optionSet:function(a,b){var c=this.dom.container.find("select."+this.c.classPrefix+"-"+a),e=c.parent().children("span");c.val(b);c=c.find("option:selected");e.html(c.length!==0?c.text():this.c.i18n.unknown)},_optionsTime:function(a,b,c){var a=this.dom.container.find("select."+this.c.classPrefix+"-"+a),e=0,d=b,f=b===12?function(a){return a}:this._pad;if(b===12){e=1;d=13}for(b=
e;b<d;b=b+c)a.append('<option value="'+b+'">'+f(b)+"</option>")},_optionsTitle:function(){var a=this.c.i18n,b=this.c.minDate,c=this.c.maxDate,b=b?b.getFullYear():null,c=c?c.getFullYear():null,b=b!==null?b:(new Date).getFullYear()-this.c.yearRange,c=c!==null?c:(new Date).getFullYear()+this.c.yearRange;this._options("month",this._range(0,11),a.months);this._options("year",this._range(b,c))},_pad:function(a){return a<10?"0"+a:a},_position:function(){var a=this.dom.input.offset(),b=this.dom.container,
c=this.dom.input.outerHeight();b.css({top:a.top+c,left:a.left}).appendTo("body");var e=b.outerHeight(),f=d("body").scrollTop();if(a.top+c+e-f>d(p).height()){a=a.top-e;b.css("top",a<0?0:a)}},_range:function(a,b){for(var c=[],e=a;e<=b;e++)c.push(e);return c},_setCalander:function(){this.s.display&&this.dom.calendar.empty().append(this._htmlMonth(this.s.display.getUTCFullYear(),this.s.display.getUTCMonth()))},_setTitle:function(){this._optionSet("month",this.s.display.getUTCMonth());this._optionSet("year",
this.s.display.getUTCFullYear())},_setTime:function(){var a=this.s.d,b=a?a.getUTCHours():0;if(this.s.parts.hours12){this._optionSet("hours",this._hours24To12(b));this._optionSet("ampm",b<12?"am":"pm")}else this._optionSet("hours",b);this._optionSet("minutes",a?a.getUTCMinutes():0);this._optionSet("seconds",a?a.getSeconds():0)},_show:function(){var a=this,b=this.s.namespace;this._position();d(p).on("scroll."+b+" resize."+b,function(){a._position()});d("div.DTE_Body_Content").on("scroll."+b,function(){a._position()});
d(s).on("keydown."+b,function(b){(b.keyCode===9||b.keyCode===27||b.keyCode===13)&&a._hide()});setTimeout(function(){d("body").on("click."+b,function(b){!d(b.target).parents().filter(a.dom.container).length&&b.target!==a.dom.input[0]&&a._hide()})},10)},_writeOutput:function(a){var b=this.s.d,b=p.moment?p.moment.utc(b,i,this.c.momentLocale,this.c.momentStrict).format(this.c.format):b.getUTCFullYear()+"-"+this._pad(b.getUTCMonth()+1)+"-"+this._pad(b.getUTCDate());this.dom.input.val(b);a&&this.dom.input.focus()}});
f.DateTime._instance=0;f.DateTime.defaults={classPrefix:"editor-datetime",disableDays:null,firstDay:1,format:"YYYY-MM-DD",i18n:f.defaults.i18n.datetime,maxDate:null,minDate:null,minutesIncrement:1,momentStrict:!0,momentLocale:"en",onChange:function(){},secondsIncrement:1,showWeekNumber:!1,yearRange:10};var N=function(a,b){if(b===null||b===i)b=a.uploadText||"Choose file...";a._input.find("div.upload button").html(b)},S=function(a,b,c){var e=a.classes.form.button,g=d('<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload"><button class="'+
e+'" /><input type="file"/></div><div class="cell clearValue"><button class="'+e+'" /></div></div><div class="row second"><div class="cell"><div class="drop"><span/></div></div><div class="cell"><div class="rendered"/></div></div></div></div>');b._input=g;b._enabled=true;N(b);if(p.FileReader&&b.dragDrop!==false){g.find("div.drop span").text(b.dragDropText||"Drag and drop a file here to upload");var h=g.find("div.drop");h.on("drop",function(e){if(b._enabled){f.upload(a,b,e.originalEvent.dataTransfer.files,
N,c);h.removeClass("over")}return false}).on("dragleave dragexit",function(){b._enabled&&h.removeClass("over");return false}).on("dragover",function(){b._enabled&&h.addClass("over");return false});a.on("open",function(){d("body").on("dragover.DTE_Upload drop.DTE_Upload",function(){return false})}).on("close",function(){d("body").off("dragover.DTE_Upload drop.DTE_Upload")})}else{g.addClass("noDrop");g.append(g.find("div.rendered"))}g.find("div.clearValue button").on("click",function(){f.fieldTypes.upload.set.call(a,
b,"")});g.find("input[type=file]").on("change",function(){f.upload(a,b,this.files,N,function(b){c.call(a,b);g.find("input[type=file]").val("")})});return g},C=function(a){setTimeout(function(){a.trigger("change",{editor:true,editorSet:true})},0)},u=f.fieldTypes,n=d.extend(!0,{},f.models.fieldType,{get:function(a){return a._input.val()},set:function(a,b){a._input.val(b);C(a._input)},enable:function(a){a._input.prop("disabled",false)},disable:function(a){a._input.prop("disabled",true)},canReturnSubmit:function(){return true}});
u.hidden={create:function(a){a._val=a.value;return null},get:function(a){return a._val},set:function(a,b){a._val=b}};u.readonly=d.extend(!0,{},n,{create:function(a){a._input=d("<input/>").attr(d.extend({id:f.safeId(a.id),type:"text",readonly:"readonly"},a.attr||{}));return a._input[0]}});u.text=d.extend(!0,{},n,{create:function(a){a._input=d("<input/>").attr(d.extend({id:f.safeId(a.id),type:"text"},a.attr||{}));return a._input[0]}});u.password=d.extend(!0,{},n,{create:function(a){a._input=d("<input/>").attr(d.extend({id:f.safeId(a.id),
type:"password"},a.attr||{}));return a._input[0]}});u.textarea=d.extend(!0,{},n,{create:function(a){a._input=d("<textarea/>").attr(d.extend({id:f.safeId(a.id)},a.attr||{}));return a._input[0]},canReturnSubmit:function(){return false}});u.select=d.extend(!0,{},n,{_addOptions:function(a,b,c){var e=a._input[0].options,g=0;if(c)g=e.length;else{e.length=0;if(a.placeholder!==i){c=a.placeholderValue!==i?a.placeholderValue:"";g=g+1;e[0]=new Option(a.placeholder,c);var h=a.placeholderDisabled!==i?a.placeholderDisabled:
true;e[0].hidden=h;e[0].disabled=h;e[0]._editor_val=c}}b&&f.pairs(b,a.optionsPair,function(a,b,c,f){b=new Option(b,a);b._editor_val=a;f&&d(b).attr(f);e[c+g]=b})},create:function(a){a._input=d("<select/>").attr(d.extend({id:f.safeId(a.id),multiple:a.multiple===true},a.attr||{})).on("change.dte",function(b,c){if(!c||!c.editor)a._lastSet=u.select.get(a)});u.select._addOptions(a,a.options||a.ipOpts);return a._input[0]},update:function(a,b,c){u.select._addOptions(a,b,c);b=a._lastSet;b!==i&&u.select.set(a,
b,true);C(a._input)},get:function(a){var b=a._input.find("option:selected").map(function(){return this._editor_val}).toArray();return a.multiple?a.separator?b.join(a.separator):b:b.length?b[0]:null},set:function(a,b,c){if(!c)a._lastSet=b;a.multiple&&a.separator&&!d.isArray(b)?b=typeof b==="string"?b.split(a.separator):[]:d.isArray(b)||(b=[b]);var e,f=b.length,h,g=false,i=a._input.find("option");a._input.find("option").each(function(){h=false;for(e=0;e<f;e++)if(this._editor_val==b[e]){g=h=true;break}this.selected=
h});if(a.placeholder&&!g&&!a.multiple&&i.length)i[0].selected=true;c||C(a._input);return g},destroy:function(a){a._input.off("change.dte")}});u.checkbox=d.extend(!0,{},n,{_addOptions:function(a,b,c){var e=a._input,g=0;c?g=d("input",e).length:e.empty();b&&f.pairs(b,a.optionsPair,function(b,c,i,l){e.append('<div><input id="'+f.safeId(a.id)+"_"+(i+g)+'" type="checkbox" /><label for="'+f.safeId(a.id)+"_"+(i+g)+'">'+c+"</label></div>");d("input:last",e).attr("value",b)[0]._editor_val=b;l&&d("input:last",
e).attr(l)})},create:function(a){a._input=d("<div />");u.checkbox._addOptions(a,a.options||a.ipOpts);return a._input[0]},get:function(a){var b=[],c=a._input.find("input:checked");c.length?c.each(function(){b.push(this._editor_val)}):a.unselectedValue!==i&&b.push(a.unselectedValue);return a.separator===i||a.separator===null?b:b.join(a.separator)},set:function(a,b){var c=a._input.find("input");!d.isArray(b)&&typeof b==="string"?b=b.split(a.separator||"|"):d.isArray(b)||(b=[b]);var e,f=b.length,g;c.each(function(){g=
false;for(e=0;e<f;e++)if(this._editor_val==b[e]){g=true;break}this.checked=g});C(c)},enable:function(a){a._input.find("input").prop("disabled",false)},disable:function(a){a._input.find("input").prop("disabled",true)},update:function(a,b,c){var e=u.checkbox,d=e.get(a);e._addOptions(a,b,c);e.set(a,d)}});u.radio=d.extend(!0,{},n,{_addOptions:function(a,b,c){var e=a._input,g=0;c?g=d("input",e).length:e.empty();b&&f.pairs(b,a.optionsPair,function(b,c,i,l){e.append('<div><input id="'+f.safeId(a.id)+"_"+
(i+g)+'" type="radio" name="'+a.name+'" /><label for="'+f.safeId(a.id)+"_"+(i+g)+'">'+c+"</label></div>");d("input:last",e).attr("value",b)[0]._editor_val=b;l&&d("input:last",e).attr(l)})},create:function(a){a._input=d("<div />");u.radio._addOptions(a,a.options||a.ipOpts);this.on("open",function(){a._input.find("input").each(function(){if(this._preChecked)this.checked=true})});return a._input[0]},get:function(a){a=a._input.find("input:checked");return a.length?a[0]._editor_val:i},set:function(a,b){a._input.find("input").each(function(){this._preChecked=
...
[a._val])},enable:function(a){a._input.find("input").prop("disabled",false);a._enabled=true},disable:function(a){a._input.find("input").prop("disabled",true);a._enabled=false},canReturnSubmit:function(){return false}});t.ext.editorFields&&d.extend(f.fieldTypes,t.ext.editorFields);t.ext.editorFields=f.fieldTypes;f.files={};f.prototype.CLASS="Editor";f.version="1.6.4";return f});
