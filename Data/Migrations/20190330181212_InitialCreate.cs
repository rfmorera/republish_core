        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalName = table.Column<string>(maxLength: 50, nullable: true),
                    ExternalPort = table.Column<int>(nullable: false),
                    FromEmail = table.Column<string>(nullable: true),
                    ExternalUsername = table.Column<string>(maxLength: 50, nullable: true),
                    ExternalPassword = table.Column<string>(maxLength: 500, nullable: true),
                    ExternalTimeout = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
